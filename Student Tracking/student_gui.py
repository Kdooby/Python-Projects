...
# Author:       Kevin Deming 
#
# Purpose:      Student Tracking.  Demonstrating OOP, Tkinter GUI module, using Tkinter
...
def load_gui(self):
    ...
    """
    self.lbl_fname = tk.Label(self.master,bg = 'black', fg = 'white', text='First Name:')
    self.lbl_fname.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_lname = tk.Label(self.master,bg = 'black', fg = 'white',text='Last Name:')
    self.lbl_lname.grid(row=2,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_phone = tk.Label(self.master,bg = 'black', fg = 'white',text='Phone Number:')
    self.lbl_phone.grid(row=4,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_email = tk.Label(self.master,bg = 'black', fg = 'white',text='Email Address:')
    self.lbl_email.grid(row=6,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_course = tk.Label(self.master,bg = 'black', fg = 'white',text='Course:')
    self.lbl_course.grid(row=8,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_info = tk.Label(self.master,bg = 'black', fg = 'white',text='Information:')
